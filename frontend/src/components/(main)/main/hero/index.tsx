...
export const HeroSection: React.FC = () => {
  return (
    <>
      <section className="relative h-fit min-h-[calc(100vh-0px)] items-center bg-gradient-to-b from-primary-50/25 from-[60%] to-primary-300/90 pb-4 text-center dark:from-black dark:to-primary-900/70">
