...
import ilDark from "../../../../public/illustration/il-4-dark.svg";
import ilLight from "../../../../public/illustration/il-4-light.svg";
import { FormHR } from "../ui/form-hr";
import { EmailVerifyCheckStatus } from "./status";

type Props = {
  locale: string;
};

export const EmailVerifyCheck: React.FC<Props> = () => {
  return (
