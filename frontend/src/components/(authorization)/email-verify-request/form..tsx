...
import { useVerifyLink } from "./use-verify-link";

export const EmailVerifyLinkForm = () => {
  const { emailRef, handleRequest, status, message } = useVerifyLink();
  ...
  return (
    <form className="flex w-full flex-col gap-8 px-4 pt-6">
      ...
      <div className="flex flex-col items-center gap-1 text-center text-sm">
        <p>
          If you already verified your email, you can{" "}
