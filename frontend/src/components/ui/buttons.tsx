...
export const ButtonPrimary: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      className={twMerge(
        `h-[2.5rem] rounded-lg border border-primary-300 bg-gradient-to-tl from-primary-400 to-primary-500 px-5 text-sm tracking-wide text-primary-50 outline-4 outline-offset-[5px] outline-primary-400 transition-all duration-300 hover:opacity-75 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 dark:border-primary-950 dark:from-primary-600 dark:to-primary-800 dark:text-primary-50`,
        className,
      )}
      {...props}
    >
